...
// 数据包配置
#define DEBUG_RX_BOOL_NUM 9  // 接收 bool 数量 9
#define DEBUG_RX_BYTE_NUM 1    // 接收 byte 数量 1
#define DEBUG_RX_SHORT_NUM 6  // 接收 short 数量 6
#define DEBUG_RX_INT_NUM 0     // 接收 int 数量
#define DEBUG_RX_FLOAT_NUM 0   // 接收 float 数量

#define DEBUG_TX_BYTE_NUM 0   // 发送 byte 数量
#define DEBUG_TX_SHORT_NUM 2  // 发送 short 数量
...
typedef struct _debuggermsg {
  ...
  uint8_t TxData[DEBUG_DATA_LEN];        // 发送数据缓冲区
  uint8_t Prefix;                        // 前缀
  uint8_t Suffix;                        // 后缀
