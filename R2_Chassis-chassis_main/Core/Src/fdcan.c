...
void MX_FDCAN1_Init(void)
{
  ...
  FDCAN_FilterTypeDef sFliterConfig;

  sFliterConfig.IdType = FDCAN_EXTENDED_ID;
  sFliterConfig.FilterIndex = 0;
  sFliterConfig.FilterType  = FDCAN_FILTER_MASK;
  sFliterConfig.FilterConfig = FDCAN_FILTER_TO_RXFIFO0;
  sFliterConfig.FilterID1 = 0x01020201;
  sFliterConfig.FilterID2 = 0xFFFFFF00;
  if(HAL_FDCAN_ConfigFilter(&hfdcan1,&sFliterConfig) != HAL_OK)
    Error_Handler();
  sFliterConfig.IdType = FDCAN_EXTENDED_ID;
  sFliterConfig.FilterIndex = 1;
  sFliterConfig.FilterType = FDCAN_FILTER_MASK;
  sFliterConfig.FilterConfig  = FDCAN_FILTER_TO_RXFIFO1;
  sFliterConfig.FilterID1 = 0x04010101;
  sFliterConfig.FilterID2 = 0xFFFFFF00;
  if(HAL_FDCAN_ConfigFilter(&hfdcan1,&sFliterConfig) != HAL_OK)
    Error_Handler();
  ...
  HAL_FDCAN_ActivateNotification(&hfdcan1,FDCAN_IT_RX_FIFO1_MESSAGE_LOST,0);
  HAL_FDCAN_ActivateNotification(&hfdcan1,FDCAN_IT_RX_FIFO1_FULL,0);
...
void MX_FDCAN2_Init(void)
{
  ...
  /* USER CODE BEGIN FDCAN2_Init 2 */
    ...
    sFilterConfig.FilterType = FDCAN_FILTER_MASK;
    sFilterConfig.FilterConfig = FDCAN_FILTER_TO_RXFIFO1;
    sFilterConfig.FilterID1 = 0x00000900;
    sFilterConfig.FilterID2 = 0xffffff00;
    if (HAL_FDCAN_ConfigFilter(&hfdcan2, &sFilterConfig) != HAL_OK)
        Error_Handler();
...
void MX_FDCAN3_Init(void)
{
  ...
  /* USER CODE BEGIN FDCAN3_Init 2 */
    ...
    if (HAL_FDCAN_ConfigFilter(&hfdcan3, &sFilterConfig) != HAL_OK)
		...
		if (HAL_FDCAN_ConfigGlobalFilter(&hfdcan3, FDCAN_REJECT, FDCAN_REJECT, FDCAN_REJECT_REMOTE,
																 FDCAN_REJECT_REMOTE)
		!= HAL_OK)
				Error_Handler();
