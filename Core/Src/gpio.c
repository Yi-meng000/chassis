...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, BEEP1_Pin|LED1_Pin|LED2_Pin|LED3_Pin
  ...
  /*Configure GPIO pins : BEEP1_Pin LED1_Pin LED2_Pin LED3_Pin
                           LED4_Pin */
  GPIO_InitStruct.Pin = BEEP1_Pin|LED1_Pin|LED2_Pin|LED3_Pin
                          |LED4_Pin;
